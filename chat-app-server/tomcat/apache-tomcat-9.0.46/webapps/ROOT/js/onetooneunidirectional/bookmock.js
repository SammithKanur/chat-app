...
function create(){
	...
	$.ajax({
		url : "/onetooneunidirectional/mock/create",
		type: "POST",
...
function update(){
	...
	$.ajax({
		url : "/onetooneunidirectional/mock/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/onetooneunidirectional/mock/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteObject(bookId){
	...
	delurl="/onetooneunidirectional/mock/remove/"+bookId;
	$.ajax({
		url : delurl,
		type: "POST",
		data : bookForm,
...
function editObject(bookId){
	editurl="/onetooneunidirectional/mock/findById/"+bookId;
	var bookForm={id:bookId};
	$.ajax({
		url : editurl,
		type: "GET",
